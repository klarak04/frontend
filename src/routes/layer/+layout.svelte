...
<AppShell slotSidebarLeft="w-0 md:w-52 bg-surface-500/10">
	...
	<svelte:fragment slot="footer">
		<div class = "foot">
    		<a href="/layer/impressum">Impressum</a>
    		<a href="/layer/datenschutz">Datenschutz</a>
    		<a href="/layer/nutzungsrichtlinien">Nutzungsrichtlinien</a>
  		<p>&copy; {year} LinkUp. Alle Rechte vorbehalten.</p>
		</div>
	</svelte:fragment>
</AppShell>
