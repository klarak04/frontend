						...
						<ul>
							<li>
								<a href="/?">
									...
									<button type="button" class="btn-icon variant-ghost-warning"><span class="material-icons-outlined" on:click={() => removeItem(0)}>clear</span></button>
								</a>
							</li>
							<li>
								<a href="/?">
							...
							<li>
								<a href="/?">
									<Avatar initials="MA" background="bg-primary-500" width="w-10" />
									<span class="flex-auto">Marc Buddemeier</span>
									<button type="button" class="btn-icon variant-ghost-warning"><span class="material-icons-outlined">clear</span></button>
								</a>
							</li>
							<li>
								<a href="/?">
